        ...
        <div className="flex flex-col lg:flex-row lg:gap-16">
          ...
          <div className="lg:w-[42vw] mb-12 lg:mb-0">
            <div ref={titleRef} style={{ opacity: 0 }}>
              <span className="micro-label mb-4 block">SERVIÇOS</span>
              <h2
                className="heading-section text-white"
                style={{ fontSize: 'clamp(26px, 3vw, 48px)' }}
              >
                Advocacia Especializada.{' '}
                <span className="text-gold">Do Planejamento ao Resultado.</span>
              </h2>
            </div>
            <p
              ref={introRef}
              ...
              style={{ opacity: 0 }}
            >
              Atendemos pessoas físicas, empresas e servidores públicos — com a mesma profundidade de análise e atenção que cada caso merece.
            </p>
