...
// Real office photos
const HERO_IMAGES = [
  { src: '/images/hero/escritorio-1.jpg', alt: 'Gabinete principal — Hering Gomes Advogados' },
  { src: '/images/hero/escritorio-2.jpg', alt: 'Recepção e sala de espera' },
  { src: '/images/hero/escritorio-3.jpg', alt: 'Sala de reunião executiva' },
  { src: '/images/hero/escritorio-4.jpg', alt: 'Ambiente de trabalho e jardim vertical' },
  { src: '/images/hero/escritorio-5.jpg', alt: 'Entrada principal do escritório' },
  { src: '/images/hero/escritorio-6.jpg', alt: 'Espaço de consulta e biblioteca jurídica' },
];
...
const HeroSection = () => {
  ...
  // Auto-scroll after 5.5 seconds Se o usuário não rolar a página
  useEffect(() => {
  ...
  return (
    <section ref={sectionRef} id="hero" className="section-pinned z-10">
      ...
      >
        ...
        >
          <span className="word inline-block">Advocacia</span>{' '}
          <span className="word inline-block">que</span>{' '}
          <span className="word inline-block text-gold">Explica,</span>{' '}
          <span className="word inline-block text-gold">Defende</span>{' '}
          <span className="word inline-block text-gold">e</span>{' '}
          <span className="word inline-block text-gold">Resolve.</span>
        </h1>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
          <div ref={bodyRef} style={{ opacity: 0 }}>
            <p className="text-secondary-gray text-base lg:text-lg leading-relaxed max-w-lg mb-3">
              A maioria dos escritórios faz promessas. Nós preferimos fazer perguntas — as certas — antes de agir. Cada caso recebe uma estratégia construída sob medida, com precisão técnica e comprometimento real do primeiro contato até a resolução final.
            </p>
            <p className="text-white/50 text-sm">
              Você acompanha cada etapa. Nós cuidamos dos resultados.<br />Atendimento presencial em Florianópolis/SC · Online em todo o Brasil.
            </p>
          </div>
