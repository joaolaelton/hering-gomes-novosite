...
const AttorneySection = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // ENTRANCE
      scrollTl.fromTo(rightPanelRef.current, { x: '60vw', opacity: 0 }, { x: 0, opacity: 1, ease: 'none' }, 0);
      scrollTl.fromTo(leftPanelRef.current, { x: '-60vw', opacity: 0 }, { x: 0, opacity: 1, ease: 'none' }, 0);
      scrollTl.fromTo(contentRef.current, { y: '10vh', opacity: 0 }, { y: 0, opacity: 1, ease: 'none' }, 0.05);
      scrollTl.fromTo(bioRef.current?.children || [], { y: '6vh', opacity: 0 }, { y: 0, opacity: 1, stagger: 0.06, ease: 'none' }, 0.1);
      scrollTl.fromTo(socialsRef.current, { y: '4vh', opacity: 0 }, { y: 0, opacity: 1, ease: 'none' }, 0.18);

      // EXIT
      scrollTl.fromTo(rightPanelRef.current, { x: 0, opacity: 1 }, { x: '18vw', opacity: 0, ease: 'power2.in' }, 0.75);
      scrollTl.fromTo(leftPanelRef.current, { x: 0, opacity: 1 }, { x: '-12vw', opacity: 0, ease: 'power2.in' }, 0.75);
      scrollTl.fromTo(contentRef.current, { y: 0, opacity: 1 }, { y: '-6vh', opacity: 0, ease: 'power2.in' }, 0.75);
      scrollTl.fromTo(bioRef.current?.children || [], { opacity: 1 }, { opacity: 0, stagger: 0.04, ease: 'power2.in' }, 0.77);
      scrollTl.fromTo(socialsRef.current, { y: 0, opacity: 1 }, { y: '3vh', opacity: 0, ease: 'power2.in' }, 0.79);
    }, section);
